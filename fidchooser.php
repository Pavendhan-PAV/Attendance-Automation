...
<body>
  ...
  <div class="ml-auto w-25">
      ...
      <div class="slide-1" style="background-image: url('images/hero_1.jpg');" data-stellar-background-ratio="0.5">
		...
		<form action=facultycontact.php method="POST">

			<select id="deta" required="" style="color: #1b1b1b; font-size: 1em; min-width: fit-content;padding-right: 70px;border: none;opacity: 0.7;min-height: 3.25em;border-radius: 0.25em; padding-left: 3.7em;" name="sid">
